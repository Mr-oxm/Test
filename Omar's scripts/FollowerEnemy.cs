...
{
    private Player player;  // Reference to the PlayerController for tracking the player
    public float speedtowardplayer;   // Speed at which the enemy moves towards the player

    // Start is called before the first frame update
    void Start()
    {
        player = FindObjectOfType<Player>();  // Find and assign the PlayerController in the scene
    }
